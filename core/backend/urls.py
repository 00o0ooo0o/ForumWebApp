...
from .views import delete_post, edit_post, create_comment, delete_comment, edit_comment, get_comment_tree, get_search_results
...
urlpatterns = [
    ...
    path('posts/<int:post_id>/comments/<int:comment_id>/', get_comment_tree),
